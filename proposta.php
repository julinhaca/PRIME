...
<head>
    ...
    <style>
        ...
        .footer .social-media a {
            color: #6c3082;
            font-size: 1em; /* Tamanho aumentado do ícone */
            margin: 0 15px;
        ...
        .footer .social-media span {
            margin-left: 5px;
            font-size: 1.0em; /* Ajuste o tamanho da fonte do nome */
        }
        ...
        /* Estilos personalizados para o ícone flutuante do WhatsApp */
        .whatsapp-float {
            position: fixed;
            bottom: 20px;
            right: 20px;
        ...
        .form-section .form-control {
            border-color: #ced4da; /* Cor neutra para os contornos */
            margin-bottom: 15px;
            border-radius: 10px; /* Bordas mais arredondadas */
            padding: 12px; /* Aumenta o espaço interno do campo */
        ...
        .form-section .btn-primary {
         ...
         /* Responsividade */
         /* Estilo para o ícone de mais opções */
        .more-options-icon {
            display: none; /* Ícone será escondido por padrão */
            color: #3f0647;
            font-size: 24px;
            margin-left: 10px;
        }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom fixed-top">
        <a class="navbar-brand" href="#home">
            <img src="LOGO.png" alt="Logo" style="height: 80px;"> PRIM3
        </a>
    ...
    <main class="container mt-4">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 info-left">
                        <h2>Equipe altamente qualificada profissionais capacitados e comprometidos.</h2>
                    </div>
                    <div class="col-md-6 info-right">
                        <p><i class="fas fa-trophy"></i> "Nossa equipe é extremamente capacitada e dedicada para administrar as atividades diárias do seu condomínio. Esperamos pela sua proposta!"
                        <br>
                        " Competência e Confiança são os pilares da prestação de serviços para seu condomínio."</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Formulário de Contato -->
         ...
         <div class="form-section">
            <h2>Solicite sua proposta sem compromisso</h2>
...
<?php elseif (isset($_GET['sucesso']) && $_GET['sucesso'] == 0): ?>
    <div class="alert alert-danger" role="alert">
        Houve um erro ao enviar sua proposta. Por favor, tente novamente.
    </div>
<?php endif; ?>
            
            <form action="email.php" name="Proposta_do_cliente" method="POST">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="nome_do_sindico" placeholder="nome do Sindico" required >
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="nome_do_condominio" placeholder="nome do Condominio" required>
                        </div>
                        <div class="form-group">
                            <input type="Email" class="form-control" name="Email" placeholder="Email"  required>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" name="message" rows="4" placeholder="Deixe sua mensagem"></textarea>
                        </div>
                    </div>
                </div>
                <button type="submit" name="Proposta_do_cliente" class="btn btn-primary">Enviar Proposta</button>
            </form>
        </div>
